        ...
        <div class="container header-inner">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Main navigation">
                <ul>
                    ...
                    <li><a href="#products"><em class="fas fa-fire"></i> Trending</a></em>
                    <li><a href="#deals"><em class="fas fa-tag"></i> Deals</a></em>
                    <li><a href="#testimonials"><em class="fas fa-star"></i> Reviews</a></em>
                </ul>
            </nav>
